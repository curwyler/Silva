...
% Font magic (XeLatex only) % !TeX program = xelatex
%\usepackage{fontspec}
%\newfontfamily\myfamily{Jellyka Castle's Queen}[Scale=2]
%\titleformat*{\chapter}{\myfamily\Huge}
%\titleformat*{\section}{\myfamily\Large}
