...
\usepackage{silva} % läuft nur mit xelatex
...
\usepackage{tabularx}
\usepackage{hyperref}
\usepackage[left=1.5cm,bottom = 3.5cm, twoside]{geometry}
...
%%NYZRATHI
%\chapter{Nyzrathi, Zetara \& Freistaaten}
...
%%MAGIE Das passt nicht zu dem Low-Magic Ansatz, der mir vorschwebt.
